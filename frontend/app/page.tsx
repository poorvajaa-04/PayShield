...
export default function Home() {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      /* -----------------------------------------------------
         STEP 3
         Fetch the investigation generated by the backend
      ----------------------------------------------------- */
              ...
              <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
                ...
                <EvidencePanel
                  ...
                  observations={
                    network
                      ? [
                          "Network behaviour detected from CIC-IDS2017 evidence.",
                ...
                <EvidencePanel
                  ...
                  observations={
                    transaction
                      ? [
                          "Transaction evidence detected from PaySim.",
